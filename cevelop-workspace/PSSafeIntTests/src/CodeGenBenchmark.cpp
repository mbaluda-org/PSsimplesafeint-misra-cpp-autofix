...
void codegenMultiplicationTest(){
    ...
    ASSERTM("expect signed integer overflow not detected by ubsan",ressi8 < si8{});
}
...
void codegenMultiplicationTest(){
    ...
    ASSERTM("expect signed integer overflow not detected by ubsan",ressi16 < si16{});
...
void codegenMultiplicationTest(){
    ...
    ASSERTM("expect signed integer overflow not detected by ubsan",ressi32 < si32{});
...
void codegenMultiplicationTest(){
    ...
    ASSERTM("expect signed integer overflow not detected by ubsan",ressi64 < si64{});
